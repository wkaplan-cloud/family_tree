...
const emailFrom = process.env.EMAIL_FROM || "Kaplan Family Tree <family@kaplan.co.za>";
...
export async function sendInviteEmail({
  ...
  return sendEmail({
    to,
    subject: `${recipientName}, your family branch is waiting for you`,
    html: `
      <div style="font-family:Arial,Helvetica,sans-serif;max-width:640px;margin:0 auto;line-height:1.6;color:#0f172a;">
        <h2 style="margin-bottom:12px;">${inviterName} added you to the Kaplan family tree</h2>
        <p>Hi ${recipientName},</p>
        <p>${inviterName} added you to a shared family tree so your branch is represented accurately and not lost over time.</p>
        <p>You can review your details, correct anything that is wrong, and add at least one relative you know so this part of the family is complete.</p>
        <p>Your knowledge may fill in names, relationships, and stories that nobody else can add.</p>
...
export async function sendReminderEmail({
  ...
  return sendEmail({
    to,
    subject: `Reminder: your family branch is still waiting for you`,
    html: `
      <div style="font-family:Arial,Helvetica,sans-serif;max-width:640px;margin:0 auto;line-height:1.6;color:#0f172a;">
